...
document.getElementById("cancelSearchBtn").addEventListener("click", hideAll);
...
document.getElementById("cancelDeleteBtn").addEventListener("click", hideAll);
...
document.getElementById("cancelShowByIdBtn").addEventListener("click", hideAll);
